...
export default function MumbaiToAnywhere() {
  const routes = seoRoutes.filter((r) => r.slug.startsWith("mumbai-"));

  return (
    <main>
      <Hero
        h1Title="Explore Our "
        h1Highlight="Mumbai Outstation Routes"
        heroSubtitle="Browse our most popular routes from Mumbai to various destinations. Professional service, transparent pricing, and comfortable rides guaranteed."
        seoMode={true}
      />
